...
d. 2 и 3.
```
##5. Из перечисленных функций: 1. познавательная; 2. описательная; 3. медотологическая; 4. научная; 5.практическая; 6. экспериментальная; 7. информационная - к экономике, как к общественной науке можно отнести: 
a. 2. 4, 6;
b. 1, 6, 7;
c. 1, 3, 5;
d. 3, 5, 7.
